...
function Home() {
    ...
    return (
        ...
        >
            ...
            <Stack maxW={i18n.language === 'en' ? { base: '100%', md: '40%' } : { base: '100%', md: '70%' }} textAlign={'center'} mb={{ base: 8, md: 0 }}>
                <Text fontSize={i18n.language === 'en' ? { base: '40px', md: '60px' } : { base: '30px', md: '50px' }}>
                    {t('MAIN.MAIN_TEXT')}
                    <Box as="span" color={'orange'}>{t('MAIN.MAIN_TEXT_ORANGE')}</Box>
                </Text>
